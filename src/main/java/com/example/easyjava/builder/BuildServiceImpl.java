...
//            bufferedWriter.newLine();
            ...
            bufferedWriter.write("\t"+"public List<"+classPoName+"> findListByParam("+classQueryName+" param){");
            bufferedWriter.newLine();
            ...
            bufferedWriter.write("\t"+"public Integer findCountByParam("+classQueryName+" param){");
            bufferedWriter.newLine();
            ...
            bufferedWriter.write("\t"+"public PaginationResultVo<"+classPoName+"> findListByPage("+classQueryName+" param){");
            bufferedWriter.newLine();
